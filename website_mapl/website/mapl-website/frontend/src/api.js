...
function normalizeAnalysis(elasticity, did, matrix, trends) {
...
export const api = {
  ...
  runCannibalization: async (id) => {
    const { ols } = await api.runAnalysisPipelineCompat(id)
    return ols
  },
  ...
  runAnalysisPipelineCompat: async (id) => {
    const { elasticity, did, matrix, trends } = await api.runAnalysisPipeline(id)
    return {
      ols: normalizeAnalysis(elasticity, did, matrix, trends),
